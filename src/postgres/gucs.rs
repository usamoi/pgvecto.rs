...
pub static OPENAI_API_KEY_GUC: GucSetting<Option<&'static str>> = GucSetting::new(None);

pub static BGWORKER_PORT: GucSetting<i32> = GucSetting::new(33509);

pub static SEARCH_K: GucSetting<i32> = GucSetting::new(64);
