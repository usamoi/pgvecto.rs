...
ALTER TYPE vector_index_stat RENAME ATTRIBUTE indexing TO idx_indexing;
ALTER TYPE vector_index_stat ALTER ATTRIBUTE idx_tuples SET DATA TYPE BIGINT;
ALTER TYPE vector_index_stat ALTER ATTRIBUTE idx_sealed SET DATA TYPE BIGINT[];
ALTER TYPE vector_index_stat ALTER ATTRIBUTE idx_growing SET DATA TYPE BIGINT[];
ALTER TYPE vector_index_stat ALTER ATTRIBUTE idx_write SET DATA TYPE BIGINT;
...
DROP FUNCTION @extschema@.vector_typmod_out;

DROP FUNCTION @extschema@.vector_typmod_in;
