...
DO LANGUAGE plpgsql $$
	...
	BEGIN
    	IF '@extschema@' != 'vectors' THEN
    	    RAISE EXCEPTION 'Please read upgrade document in https://docs.pgvecto.rs/admin/upgrading.html#upgrading-from-0-1-x.';
    	END IF;
	END;
$$;
...
ALTER FUNCTION vector_in(cstring, oid, INT) RENAME TO _vectors_vecf16_in;
...
ALTER FUNCTION vector_out(vecf16) RENAME TO _vectors_vecf16_out;
...
ALTER FUNCTION operator_add(vecf16, vecf16) RENAME TO _vectors_vecf16_operator_add;
...
ALTER FUNCTION operator_minus(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_minus;
...
ALTER FUNCTION operator_eq(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_eq;
...
ALTER FUNCTION operator_neq(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_neq;
...
ALTER FUNCTION operator_lt(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_lt;
...
ALTER FUNCTION operator_gt(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_gt;
...
ALTER FUNCTION operator_lte(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_lte;
...
ALTER FUNCTION operator_gte(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_gte;
...
ALTER FUNCTION operator_l2(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_l2;
...
ALTER FUNCTION operator_dot(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_dot;
...
ALTER FUNCTION operator_cosine(vecf16, vecf16) RENAME TO  _vectors_vecf16_operator_cosine;
...
DROP FUNCTION @extschema@.vector_stat;

DROP FUNCTION @extschema@.cast_vector_to_array;

DROP FUNCTION @extschema@.cast_array_to_vector;

DROP FUNCTION @extschema@.ai_embedding_vector;
